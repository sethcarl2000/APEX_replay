...
////////////////////////////////////////////////////////////////////////////////////
S2Hit::S2Hit( bool arm, int paddle, double T_pmtL, double T_pmtR ) {
...
double S2Hit::DeltaT_raw() const
{ 

  return (fRawTime_pmtR - fRawTime_pmtL)/fTDC_resolution; 
}
double S2Hit::Compute_RealTime() {
...
void S2Hit::Make_twinHit( S2Hit *neighbor ) { 
