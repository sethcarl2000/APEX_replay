#ifndef Podd_THaApexShower_h_
#define Podd_THaApexShower_h_
...
class THaApexShower : public THaPidDetector {
  
public:
  THaApexShower( const char* name, const char* description = "",
	     THaApparatus* a = NULL );
  THaApexShower();
  virtual ~THaApexShower();
